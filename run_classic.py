...
if len(sys.argv) != 3:
    print("usage: run_classic [test_name] [time_limit]")
    exit()
...
with open('classic_solvers/solvers.txt', 'r') as file:
...
for command_full in commands:
    ...
    for instance_group in instance_groups:
        ...
        for filename in os.listdir(group_path):
            ...
            result = subprocess.run(formatted_command, shell=True, capture_output=True,cwd="classic_solvers/")
